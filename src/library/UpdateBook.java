...
int rt=0;
      ...
      JOptionPane.showMessageDialog(null, "ISBN Must be 13 Characters" ,"Warning",JOptionPane.WARNING_MESSAGE);
      rt=0;
  }
        else if(CheckBook(jTextField1.getText())==0 )
            {
                JOptionPane.showMessageDialog(null, "This ISBN Doesn't Exist","Warning",JOptionPane.WARNING_MESSAGE);
                rt=0;
            } 
              ...
              try {
                    ...
                    String query="UPDATE books SET ISBN='"+jTextField1.getText()+"', name='"+jTextField2.getText()+"' ,wName='"+jTextField3.getText()+"',wSurname='"+jTextField4.getText()+"',publisher='"+jTextField5.getText()+"',pub_Year='"+jTextField6.getText()+"',type='"+jTextField7.getText()+"',stock='"+jTextField8.getText()+"' WHERE ISBN="+jTextField1.getText();
